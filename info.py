...
MOVIE_UPDATE_CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('MOVIE_UPDATE_CHANNELS', '-1002481569627 -1002414133579').split()]  # Notification of sent to your channel
